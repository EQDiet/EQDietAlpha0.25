...
public final class EQDietAlpha025 extends javax.swing.JFrame{
        ...
        FileWriter fwS=new FileWriter("FoodLog.txt");
            try (BufferedWriter fW = new BufferedWriter(fwS)) {
                do{
                    ...
                    fW.write("Session 1:");
                    jTextArea3.setText("---------------------------------------------------------------\n"
                            + "File generated by EQdiet Alpha. Developed by Daniel Lopez Tena.\n"
                            + "---------------------------------------------------------------\n"
                            + "Session 1:\n");
                    duration = 0;
                }while(duration>0);
        ...
        if(eaten == 2){
            ...
            try (BufferedWriter fS = new BufferedWriter(flS)) {
                do{
                    ...
                    fS.newLine();
                    fS.write("The EQDiet Team.");
                    fS.newLine();
                    jTextArea3.setText("---------------------------------------------------------------\n"
                            + "File generated by EQdiet Alpha. Developed by Daniel Lopez Tena.\n"
                            + "---------------------------------------------------------------\n"
                            + "Thanks for using EQDiet Alpha!\n"
                            + "Coded by: Daniel Lopez Tena.\n"
                            + "Thanks to Daniel Andrade and Miguel Angel Picazo for helping me in this proyect.\n"
                            + "And special thanks to Pedro Hernandez for coordinating this amazing proyect.\n"
                            + "Hope you enjoyed using this product!\n"
                            + "The EQDiet Team.\n\n");
                    logquantity = 0;
                    duration = 0;
                    eaten = 0;
    ...
    */
           ...
           if (java.awt.Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(java.awt.Desktop.Action.BROWSE)) {
                try {
                    ...
                    Logger.getLogger(EQDietAlpha025.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
    ...
    /**
     * Creates new form EQDietAlpha025
     */
    public EQDietAlpha025() {
        this.duration = 1;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Version 0.25 Alpha");
    ...
    @SuppressWarnings({"ConvertToStringSwitch", "DeadBranch"}) //Deletes the convert to switch...case hint in NetBeans
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            if("Bread".equals(dish) || "bread".equals(dish)){
                ...
                jLabel5.setText("The specified food does not actually exist");
            }
...
if(restartsession == 1){
    ...
    public static void main(String args[]){
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EQDietAlpha025.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new EQDietAlpha025().setVisible(true);
        });
    }
